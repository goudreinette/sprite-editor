...
var _user$project$Model$initMatrix = A3(
	_chendrix$elm_matrix$Matrix$matrix,
	10,
	10,
	_elm_lang$core$Basics$always(_elm_lang$core$Color$white));
var _user$project$Model$transparent = A4(_elm_lang$core$Color$rgba, 0, 0, 0, 0);
var _user$project$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {tool: a, zoom: b, matrix: c, color: d, mousedown: e, showGrid: f, showSave: g};
	});
var _user$project$Model$Pipette = {ctor: 'Pipette'};
var _user$project$Model$Erase = {ctor: 'Erase'};
var _user$project$Model$Paint = {ctor: 'Paint'};
var _user$project$Model$initModel = {tool: _user$project$Model$Paint, zoom: 1, matrix: _user$project$Model$initMatrix, color: _elm_lang$core$Color$black, mousedown: false, showGrid: true, showSave: false};

var _user$project$Update$useTool = F2(
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							color: A2(
								...
								A2(_chendrix$elm_matrix$Matrix$get, location, model.matrix))
						});
			}
		}
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'UseTool':
				return A2(_user$project$Update$useTool, _p1._0, model);
			case 'UseToolSingle':
				return A2(
...
var _user$project$Update$ToggleSave = {ctor: 'ToggleSave'};
			...
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'overlay',
						A2(_user$project$View$activeClass, model.showSave, true))),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('close fa fa-times'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$ToggleSave),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'background-color',
								_1: _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgba(color)
							},
							_1: {ctor: '[]'}
						}),
					_1: {
	...
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_user$project$View$tool, _user$project$Model$Pipette, 'crosshairs', model.tool),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('save fa fa-floppy-o'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$ToggleSave),
										_1: {ctor: '[]'}
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$value(
												_eskimoblood$elm_color_extra$Color_Convert$colorToHex(model.color)),
											_1: {
												ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$modal, 'Save', model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Model$initModel, update: _user$project$Update$update, view: _user$project$View$view})();
